            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        name: "Mohalla Bazaar",
                        url: "https://mohallabazaar.shop",
                        logo: "https://mohallabazaar.shop/logo.png",
                        sameAs: [

                            "https://instagram.com/mohallabazaar",
                        ],
                        description:
                            "Order fresh vegetables, groceries, and daily essentials with Mohalla Bazaar. Fast delivery within 30 minutes.",
                    }),
                }}
            />
            ...
            <div className="flex flex-col min-h-screen font-sans bg-gray-900 text-white">
                ...
                <section className="flex-1 flex flex-col items-center justify-center text-center px-6 py-20 relative overflow-hidden bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight animate-fadeIn">
                        <span className="text-green-400">Mohalla Bazaar – Everything delivered in 30 minutes
                        </span>
                    </h1>
                    ...
                    <p className="mt-4 sm:mt-6 text-sm sm:text-base text-gray-400">For Android devices only • Version 1.0.6</p>
                </section>
